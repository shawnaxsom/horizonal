...
const SunIcon = require("../if_kweather_1403.png");
...
const Header = ({
  ...
  return [
    <img
      ...
      style={{
        position: "absolute",
        ...(isDesktop ? {width: 96} : {width: 32}),
      }}
    />,
    <div
      style={{
        width: "100%",
        ...(isDesktop ? {marginLeft: 120, paddingLeft: 10} : {marginLeft: 40}),
      }}
    >
      <Field hasAddons>
        <Control>
    ...
    <div
      style={{
        width: "100%",
        marginTop: 8,
        ...(isDesktop ? {marginLeft: 120} : {marginLeft: 0}),
      }}
    >
      <Slider
        min={0}
